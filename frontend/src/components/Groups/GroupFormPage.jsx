...
const GroupFormPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const group = { name, about, type, city, state, private: isPrivate };
    const newGroup = await dispatch(groupActions.createGroup(group));
    if (newGroup.groups.errors) {
      console.log("THIS IS NEWGROUP ERRS: ", newGroup.errors)
      setErrs(newGroup.errors);
    } else {
